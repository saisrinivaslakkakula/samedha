...
export default function TheFuture() {
  return (
    <SectionWrapper id="future" className="py-28 px-6 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-text-dim/20 rounded-2xl overflow-hidden">
        {/* For Me */}
        <div className="bg-bg p-10 flex flex-col gap-6">
          <div>
            <span className="font-sans text-xs text-gold tracking-widest uppercase">
              For Me
            </span>
            <h3 className="font-serif text-3xl text-text-primary mt-2 font-light">
              The cyborg build.
            </h3>
          </div>
        ...
        <div className="bg-surface p-10 flex flex-col gap-6">
          ...
          <p className="font-sans text-text-dim text-xs leading-relaxed mt-auto">
